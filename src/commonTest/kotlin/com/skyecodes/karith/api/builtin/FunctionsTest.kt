...
class FunctionsTest {
    @Test
    fun testFunction_ShouldReturnCorrectValue(args: Arguments = burstValues(
    ...
    data class Arguments(val expectedValue: Double, val function: KthFunction, val args: List<Double>) {
        constructor(expectedValue: Double, function: KthFunction, vararg args: Double) : this(expectedValue, function, args.toList())
    }
}