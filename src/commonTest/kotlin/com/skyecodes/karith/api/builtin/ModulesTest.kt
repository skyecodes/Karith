...
class ModulesTest {
    @Test
    fun testModule_ShouldContainElements(args: Arguments = burstValues(
        Arguments(
            Modules.BASE,
            Operators.TIMES,
    ...
    data class Arguments(val module: KthModule, val expectedCombinerOperator: KthOperator?, val expectedElements: List<KthElement>) {
        constructor(module: KthModule, expectedCombinerOperator: KthOperator?, vararg expectedElements: KthElement) : this(module, expectedCombinerOperator, expectedElements.toList())
    }
}