...
import dev.franckyi.karith.api.builtin.Modules
import dev.franckyi.karith.api.builtin.Operators
import dev.franckyi.karith.impl.*
 ...
 */
@JvmName("constantExt")
infix fun String.constant(value: Number): KthConstant = constant(this, value)
...
fun String.operator(
    ...
    leftAssociative: Boolean = true,
    operation: (Double, Double) -> Double
): KthOperator = operator(this, precedence, leftAssociative, operation)
 ...
 */
@JvmName("functionExt")
fun String.function(argCount: Int, function: (DoubleArray) -> Double): KthFunction = function(this, argCount, function)
 ...
 * @return the created [KthFunction]
 */
fun function1(key: String, function: (Double) -> Double): KthFunction = function(key, 1) { function(it[0]) }
 ...
 * @return the created [KthFunction]
 */
@JvmName("function1Ext")
infix fun String.function1(function: (Double) -> Double): KthFunction = function1(this, function)
 ...
 * @return the created [KthFunction]
 */
fun function2(key: String, function: (Double, Double) -> Double): KthFunction =
 ...
 * @return the created [KthFunction]
 */
@JvmName("function2Ext")
infix fun String.function2(function: (Double, Double) -> Double): KthFunction = function2(this, function)