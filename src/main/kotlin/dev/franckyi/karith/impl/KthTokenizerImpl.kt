...
internal class KthTokenizerImpl(
    ...
    private var declaredVars: Array<out String>? = null

    override fun tokenize(expr: String, declaredVars: Array<out String>?): Pair<List<KthToken>, Set<String>> {
    ...
    private fun cleanup(declaredVars: Array<out String>?) {
        index = 0
        buffer = ""
